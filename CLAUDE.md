# agent-fleet-notes -- working notes

This repo is PUBLIC and prose-only: a de-identified account of the private agent fleet
(Vito, Sonny, Emily, Anna, Ada, Thoth). The code lives in the private project directories;
this is the story of the design rules and incidents.
...
- Incidents are told plainly, including the unsubscribe-gap one; Peter approved that framing
  2026-09-07. Do not soften or remove it without asking him.
- Keep the mermaid diagram in the README in step with the agent table when an agent is added.
- Licence is CC BY 4.0 (prose), not MIT.
